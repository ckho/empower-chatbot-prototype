...
const askGender = convo => {
  convo.ask(convo => {
    const buttons = [{ type: 'postback', title: 'Male', payload: 'GENDER_MALE' }, { type: 'postback', title: 'Female', payload: 'GENDER_FEMALE' }, { type: 'postback', title: 'I don\'t wanna say', payload: 'GENDER_UNKNOWN' }];
...
bot.hear('hey', (payload, chat) => {
  chat.say('Hello friend', { typing: true }).then(() => chat.say('So, I’m good at talking about the weather. Other stuff, not so good. If you need help just enter “help.”', { typing: true }));
});
